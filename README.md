...
# REMEMBER: You need to change the "LABEL" variabile in python/Kat_logger.py script with your USB stick name, then open "AUTORUN.INF on the USB stick and change the LABEL variabile with your USB stick name 
